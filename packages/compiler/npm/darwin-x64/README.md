...
```bash
npm install @aihu/compiler-darwin-x64
# or
bun add @aihu/compiler-darwin-x64
```

<sub><i>Auto-generated against `@aihu/compiler-darwin-x64@1.3.5`.</i></sub>
