...
```bash
npm install @aihu/compiler-linux-x64-gnu
# or
bun add @aihu/compiler-linux-x64-gnu
```

<sub><i>Auto-generated against `@aihu/compiler-linux-x64-gnu@1.3.5`.</i></sub>
