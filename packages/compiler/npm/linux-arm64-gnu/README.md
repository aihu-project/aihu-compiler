...
```bash
npm install @aihu/compiler-linux-arm64-gnu
# or
bun add @aihu/compiler-linux-arm64-gnu
```

<sub><i>Auto-generated against `@aihu/compiler-linux-arm64-gnu@1.3.5`.</i></sub>
