# @aihu/compiler-native-linux-arm64-gnu

> **Aihu** — agentic discovery and interaction, for human purpose.

aihu compiler native addon (napi) — linux-arm64-gnu platform binary.
...
```bash
npm install @aihu/compiler-native-linux-arm64-gnu
# or
bun add @aihu/compiler-native-linux-arm64-gnu
```

<sub><i>Auto-generated against `@aihu/compiler-native-linux-arm64-gnu@1.3.5`.</i></sub>
