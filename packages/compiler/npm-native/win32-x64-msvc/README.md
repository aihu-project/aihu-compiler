# @aihu/compiler-native-win32-x64-msvc

> **Aihu** — agentic discovery and interaction, for human purpose.

aihu compiler native addon (napi) — win32-x64-msvc platform binary.
...
```bash
npm install @aihu/compiler-native-win32-x64-msvc
# or
bun add @aihu/compiler-native-win32-x64-msvc
```

<sub><i>Auto-generated against `@aihu/compiler-native-win32-x64-msvc@1.3.5`.</i></sub>
