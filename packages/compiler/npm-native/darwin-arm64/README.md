# @aihu/compiler-native-darwin-arm64

> **Aihu** — agentic discovery and interaction, for human purpose.

aihu compiler native addon (napi) — darwin-arm64 platform binary.
...
```bash
npm install @aihu/compiler-native-darwin-arm64
# or
bun add @aihu/compiler-native-darwin-arm64
```

<sub><i>Auto-generated against `@aihu/compiler-native-darwin-arm64@1.3.5`.</i></sub>
