# @aihu/compiler-native-darwin-x64

> **Aihu** — agentic discovery and interaction, for human purpose.

aihu compiler native addon (napi) — darwin-x64 platform binary.
...
```bash
npm install @aihu/compiler-native-darwin-x64
# or
bun add @aihu/compiler-native-darwin-x64
```

<sub><i>Auto-generated against `@aihu/compiler-native-darwin-x64@1.3.5`.</i></sub>
